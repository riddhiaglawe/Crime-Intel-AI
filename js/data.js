...
import { analyzeProvisionsLocally } from './legal-provisions.js';
  ...
  applications: [
    {
      ...
      suggestedLegalProvisions: {
        analyzedAt: '2026-02-10T16:30:00.000Z',
        status: 'Reviewed',
        source: 'Verified BNS 2023 Analysis Engine (Advisory)',
        provisions: [
          {
            id: 'lp_init_1_1',
            sno: 1,
            ...
            offence: 'Theft',
            reason: 'Dishonest removal and taking of parked two-wheeler vehicle without owner consent.',
            relevance: 'High',
            decision: 'Accepted',
            officerRemarks: 'Matches complainant vehicle registration and missing time window.',
            reviewedBy: 'Inspector R. Verma',
            officerId: 'u_police_1',
            reviewedAt: '2026-02-11T09:20:00.000Z'
          },
          {
            id: 'lp_init_1_2',
            sno: 2,
            ...
            reason: 'Suspect observed loitering with master key set targeting multiple two-wheelers for fencing.',
            relevance: 'Medium',
            decision: 'Accepted',
            officerRemarks: 'Correlated with repeat two-wheeler fencing pattern in Sitabuldi.',
            reviewedBy: 'Inspector R. Verma',
            officerId: 'u_police_1',
            reviewedAt: '2026-02-11T09:20:00.000Z'
          }
    ...
    },
    {
      ...
      suggestedLegalProvisions: {
        analyzedAt: '2026-02-14T08:45:00.000Z',
        status: 'Suggested',
        source: 'Verified BNS 2023 Analysis Engine (Advisory)',
        provisions: [
          {
            ...
            act: 'Bharatiya Nyaya Sanhita, 2023',
            section: 'Section 331',
            offence: 'House-trespass or House-breaking',
            reason: 'Forced entry by shattering rear commercial glass panel during night hours.',
            relevance: 'High',
            decision: 'Pending',
            officerRemarks: '',
            reviewedBy: null,
          ...
          },
          {
            ...
            act: 'Bharatiya Nyaya Sanhita, 2023',
            section: 'Section 305',
            offence: 'Theft in building / place of custody',
            reason: 'Theft of 6 premium smartphones and store cash register from commercial building premises.',
            relevance: 'High',
            decision: 'Pending',
            officerRemarks: '',
            reviewedBy: null,
...
function ensureDataStructure(target) {
  ...
  if (!Array.isArray(target.applications)) {
    ...
    // Ensure all applications have suggestedLegalProvisions initialized
    target.applications.forEach(app => {
      if (!app.suggestedLegalProvisions || !Array.isArray(app.suggestedLegalProvisions.provisions)) {
        app.suggestedLegalProvisions = {
          analyzedAt: app.createdAt || new Date().toISOString(),
          status: 'Suggested',
          source: 'Verified BNS 2023 Rule Engine (Advisory)',
          provisions: analyzeProvisionsLocally(app)
        };
      }
    });
  }
...
export async function createCitizenComplaint({
  ...
  const newApp = {
    ...
    rejectedAt: null,
    rejectionReason: null,
    assignedPoliceStation: assignedPoliceStation || null,
    handlingDept: assignedPoliceStation
      ? `${assignedPoliceStation.name} — Nagpur Police`
      : 'Nagpur Police — Investigation Unit',
    ...
    suggestedLegalProvisions: {
      ...
      status: 'Suggested',
      source: 'Verified BNS 2023 Rule Engine (Advisory)',
      provisions: analyzeProvisionsLocally({
        title,
        category,
        incidentDate,
        location,
